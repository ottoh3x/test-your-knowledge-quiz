...
export default function WrongAnswersModal({wrongAnswers,onClose} : {wrongAnswers : string[],onClose : () => void}) {
  return (
...
<div key={answer} className="border-t border-b py-2">
<p className="text-sm text-gray-500">Question: {answer.question}</p>
...
<p className="text-sm text-green-500">Correct answer: {answer.correctAnswer}</p>
</div>
